...
<head>
    ...
    <title>Açai da Dora - Pedido Online</title>
    <!-- Bootstrap CSS -->
	<link rel="icon" type="image/png" href="./images/favicon.png">
    <!-- Meta tag para descrição -->
    ...
    <style>
        ...
        body {
            ...
            background-image: url('./images/walpaper.jpg'); /* Imagem de fundo */
       ...
       .card {
            margin-bottom: 30px;
            padding: 20px; /* Adicione o padding desejado */
            border: none;
            border-radius: 0;
        ...
        .btn-flutuante i {
            font-size: 24px;
            color: white !important; /* Adicione !important para garantir que a cor branca seja aplicada */
        }
